...
<body>
    ...
    <div id="receipt">
        <a href="{{ route('download', $order['id']) }}" class="btn-print">Cetak (.pdf)</a>
        <center id="top">
            <div class="info">
        ...
        <div id="bot">
            <div id="table">
                <table>
                    ...
                    @foreach ($order['medicines'] as $medicine)
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext">{{$medicine['name_medicines']}}</p>
                            </td>
                            <td class="tableitem">
            ...
            <div id="legalcopy">
                <p class="legal"><strong>terima kasih atas pembelian anda!</strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            </div>
        </div>
    </div>
</body>
